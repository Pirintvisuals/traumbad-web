...
// "Alle Leistungen im Detail" — das vollständige Leistungsverzeichnis als ruhige,
// scanbare Liste (keine Kartenwand). Jede Zeile verlinkt direkt zur ausführlichen
// Erklärung auf der jeweiligen Paket-Unterseite.
