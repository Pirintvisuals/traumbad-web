...
export default function LeistungenPage() {
  return (
    <main>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
          ...
          <Reveal delay={0.08}>
            <p className="text-white/55 text-lg leading-relaxed max-w-2xl">
              Wählen Sie ein Paket, das zu Ihrem Vorhaben passt — oder sehen Sie sich unten
              jede einzelne Leistung im Detail an. Egal wofür Sie sich entscheiden: Der Preis
              steht vorher fest.
            </p>
          </Reveal>
        </div>
      ...
      {/* Pakete (Karten) + vollständiges Leistungsverzeichnis */}
      <Leistungen />
